...
export { DEFAULT_PARAMS, computeContext, detect, validate, signalVotes } from './strategy';
export { normCdf, normInv, psr, expectedMaxSharpe, deflatedSharpe, returnMoments } from './validation';
