...
*As of equities 2026-07-07 / crypto 2026-07-07. Rules-based model portfolio for research/education. Not financial advice, not a prediction. Every weight traces to a measured, cited rule; the rules are tilts and risk controls, not knowledge of the future.*

| Weight | Asset | Sleeve | Rule (auditable) |
|---|---|---|---|
| 10.8% | **TLT** | diversifier | low measured STRESS-day correlation to equities (study 4) |
| 9.8% | **EEM** | core | inverse-vol core (12m vol 19%), cap 20% + momentum-tilt: top-3 composite screen; documented factor, but it FAILED our own 3y test (study 5) — kept small |
| 9.3% | **SPY** | core | inverse-vol core (12m vol 15%), cap 20% |
| 9.2% | **EFA** | core | inverse-vol core (12m vol 16%), cap 20% |
| 7.3% | **GLD** | diversifier | low measured STRESS-day correlation to equities (study 4) |
| 7.1% | **QQQ** | core | inverse-vol core (12m vol 20%), cap 20% |
| 6.7% | **IWM** | core | inverse-vol core (12m vol 21%), cap 20% |
| 2.4% | **GOOGL** | momentum-tilt | top-3 composite screen; documented factor, but it FAILED our own 3y test (study 5) — kept small |
| 2.4% | **XLK** | momentum-tilt | top-3 composite screen; documented factor, but it FAILED our own 3y test (study 5) — kept small |
| 35.0% | **CASH** | reserve | cash floor + vol-target overlay overflow + closed crypto gate |

Portfolio vol overlay: realized 16.6% vs target 12% → scale 0.72.
