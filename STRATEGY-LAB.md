...
|---|---|---|---|---|---|---|---|
| trend | 10/38 | -0.2% | -12.7% | 0.42% | -1.2% | 52 | 20 |
| trend+vt | 11/38 | +0.1% | -7.4% | 0.26% | -0.5% | 52 | 20 |
| meanrev | 8/38 | -5.7% | -12.1% | 0.40% | +0.0% | 37 | 17.5 |
| breakout | 10/38 | -1.9% | -9.8% | 0.41% | -0.7% | 47 | 18 |
| ensemble | 10/38 | +0.0% | -6.3% | 0.24% | -2.0% | 43 | 9 |
| ensemble+vt | 10/38 | +0.0% | -2.8% | 0.14% | -0.8% | 43 | 9 |

Median buy-and-hold across the same assets: **+43.7%**.
...
Which variant most often had the best raw Sharpe per asset (before deflation): breakout (9), meanrev (8), trend+vt (8), ensemble+vt (5), trend (4), ensemble (4).
