...
|---|---|---|---|---|---|---|---|
| trend | 11/38 | -0.1% | -12.5% | 0.42% | -1.9% | 53 | 20 |
| trend+vt | 11/38 | +0.1% | -7.4% | 0.26% | -0.6% | 53 | 20 |
| meanrev | 9/38 | -4.7% | -12.0% | 0.41% | +0.0% | 40 | 17.5 |
| breakout | 10/38 | -0.7% | -9.8% | 0.41% | -0.4% | 49 | 18 |
| ensemble | 10/38 | +0.0% | -6.3% | 0.24% | -1.3% | 40 | 9 |
| ensemble+vt | 9/38 | +0.0% | -2.8% | 0.14% | -0.8% | 40 | 9 |

Median buy-and-hold across the same assets: **+37.8%**.
...
Which variant most often had the best raw Sharpe per asset (before deflation): meanrev (10), breakout (8), trend+vt (7), ensemble+vt (5), ensemble (5), trend (3).
